...
class Nivel_tres(Nivel):
    def __init__(self, pantalla: pygame.Surface):
        ...
        bat_uno = Enemigo((35,35), animaciones_bat, (600, 650), 5, (500, 1300))

        lista_enemigos = [slime_uno, slime_dos, bat_uno]
        ...
        super().__init__(pantalla, mi_personaje, lista_dibujar_rectangulos, fondo, lados_piso, piso_img, "nivel_cuatro")